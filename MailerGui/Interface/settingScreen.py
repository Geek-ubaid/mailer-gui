...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(726, 453)
        self.widget = QtWidgets.QWidget(Dialog)
        self.widget.setGeometry(QtCore.QRect(9, 9, 701, 361))
        ...
        self.apikey_box.setEchoMode(QtWidgets.QLineEdit.PasswordEchoOnEdit)
        ...
        self.widget1.setGeometry(QtCore.QRect(460, 400, 239, 25))
